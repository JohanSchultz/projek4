          ...
          {showReset && (
            ...
            >
              ...
              <button
                ...
                className="rounded border border-zinc-300 bg-white py-2 text-sm font-medium text-zinc-700 bg-zinc-50 disabled:opacity-50 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-700"
              >
