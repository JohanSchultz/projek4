...
export default async function MenuPage() {
  ...
  const menuVisibility = {
    ...
    averagePartUsagePerMonth: hasFunctionId(gridRows, 20),
    partUsageAsPercOfJobs: hasFunctionId(gridRows, 21),
    servicesDone: hasFunctionId(gridRows, 22),
    jobsPerTechnician: hasFunctionId(gridRows, 23),
    jobCountPerEquipmentItem: hasFunctionId(gridRows, 25),
    qtyServicedByType: hasFunctionId(gridRows, 26),
    individualItemHistory: hasFunctionId(gridRows, 27),
    costByAreaAndType: hasFunctionId(gridRows, 28),
    monthlyCostPerEquipmentType: hasFunctionId(gridRows, 29),
    costPerEquipmentItem: hasFunctionId(gridRows, 30),
    noRecentJobs: hasFunctionId(gridRows, 31),
    equipmentAbuse: hasFunctionId(gridRows, 32),
    equipmentPopulationByArea: hasFunctionId(gridRows, 33),
    meanTimeBetweenFailures: hasFunctionId(gridRows, 34),
  };
